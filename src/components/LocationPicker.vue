    ...
    <v-dialog v-model="showDialog" max-width="500px">
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <div v-else-if="hasSearched && searchQuery && !isLoading" class="text-center py-4">
            No locations found
          </div>
...
async function getCurrentLocation() {
  ...
  try {
    ...
    locationError.value = 'Could not get your location. Please try again or search manually.';
  } finally {
